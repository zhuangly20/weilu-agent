...
GREETING_TEXT = """（炉火噼啪，小木屋的门被推开，一股凉气进来，又被暖意接住）
...
ENDED_TEXT = """【小晴】炉火慢慢暗下去了，谢谢你来～
想再开一场的话，跟我说声\"再来一场\"，或者直接说下一场想聊的主题。炉子随时可以重新生起来。"""

LLM_FALLBACK_TEXT = """【小晴】（往炉子里添了根柴，火光晃了晃）炉火有点慢，刚才那句话我没有接稳。能再对我说一遍吗？"""
...
def build_invite_system_prompt(
    ...
    if form == "painting":
        ...
        scheme = (
            ...
            "想听谁多说两句，随时点名\n"
            "- 时长：大约10-15分钟\n"
            "- 收获：一份根据本场对话亲手写的《成长手记》和一张专属明信片✨（先卖个关子～）"
        )
    blocks = [
        "你是\"清心圆桌\"的导演。本轮完成\"介绍与相邀\"：小晴主持介绍方案，四位桌友各自亮相一句。",
...
def build_encore_system_prompt(leader_cfg: dict, theme_label: str) -> str:
    ...
    return "\n\n".join(
        [
            ...
            "2) 常见问题可以这样答：问明信片/成长手记——在上一条\"成长手记\"消息的下方附件卡片里，"
