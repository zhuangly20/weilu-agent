...
【小晴】今天的圆桌有三类活动，想参加哪一场？

**深度团体**（约20分钟，几位AI团友围坐陪你聊透一件事）
1️⃣ **减压安心之旅**——学业、科研、生活，把压力放到圆桌上
2️⃣ **新生适应**——想家、宿舍、新环境，你不是一个新人
3️⃣ **爱情探索**——心动、异地、表白与错过，聊聊亲密关系
4️⃣ **就业迷茫**——秋招、考研、Gap，路口上的同行人

**轻团体**（约10分钟，安静共创）
5️⃣ **圆桌画室**——大家用文字各添一笔，共同完成一幅真正的画，结束送你一张明信片

**对话面板**
6️⃣ **时空对话**——司马迁、项羽、张良……点四位史记人物，一问四答，看他们隔世辩论

深度团体结束会送你一份《圆桌留笺》。回复数字或活动名就能报名；也可以直接跟我说说最近的困惑，我来帮你挑一场最合适的～

（小声说：清心圆桌是朋辈支持空间，不是心理治疗哦。如果你正处于难以承受的痛苦中，请一定联系学校心理中心或专业援助热线。）"""

MENU_RETRY_TEXT = """【小晴】（歪着头）桌边有点热闹，我没太听清你想参加哪一场——
1️⃣ 减压安心之旅　2️⃣ 新生适应　3️⃣ 爱情探索　4️⃣ 就业迷茫
5️⃣ 圆桌画室　6️⃣ 时空对话
